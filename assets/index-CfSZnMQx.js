(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const l of n)if(l.type==="childList")for(const i of l.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function s(n){const l={};return n.integrity&&(l.integrity=n.integrity),n.referrerPolicy&&(l.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?l.credentials="include":n.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function a(n){if(n.ep)return;n.ep=!0;const l=s(n);fetch(n.href,l)}})();function v(e,t,s){return{id:e,tableNo:t,label:s}}function K(e,t,s){return{id:e,label:t,children:s}}const Gt=[K("1","隧道岩土体物理力学指标",[K("1-1","岩石物理力学性质指标",[v("1-1-1","1.1.1","中风化灰岩物理力学性质统计表（T1 j1）"),v("1-1-2","1.1.2-2","中风化泥岩物理力学性质统计表（T1f4）"),v("1-1-3","4.1.2-3","中风化灰岩物理力学性质统计表（T1f3）"),v("1-1-4","4.1.2-4","中风化泥灰岩物理力学性质统计表（T1f1）"),v("1-1-5","4.1.2-5","中风化灰岩物理力学性质统计表（P3c）"),v("1-1-6","4.1.2-6","中风化灰岩物理力学性质统计表（P3l）"),v("1-1-7","4.1.2-7","中风化炭质页岩物理力学性质统计表（P3l）"),v("1-1-8","4.1.2-8","中风化铝土页岩物理力学性质统计表（P3l）"),v("1-1-9","4.1.2-9","中风化页岩物理力学性质统计表（P3l 背斜西翼）"),v("1-1-10","4.1.2-10","中风化页岩物理力学性质统计表（P3l 背斜东翼）"),v("1-1-11","4.1.2-11","中风化灰岩物理力学性质统计表（P2m）"),v("1-1-12","4.1.2-12","中风化灰岩夹页岩物理力学性质统计表（P2m）"),v("1-1-13","4.1.2-13","中风化灰岩物理力学性质统计表（P2q）"),v("1-1-14","4.1.2-14","中风化页岩物理力学性质统计表（P1l）"),v("1-1-15","4.1.2-15","中风化页岩物理力学性质统计表（S2h）"),v("1-1-16","4.1.2-16","中风化白云质灰岩物理力学性质统计表（T1j2）"),v("1-1-17","4.2.1-16","中风化页岩物理力学性质统计表（断层角砾岩）")]),K("1-2","围岩弹性波速",[v("1-2-1","4.2.2-1","进出洞口钻孔物探声波测井测试成果表"),v("1-2-2","4.2.2-2","洞身段钻孔物探声波测井测试成果表"),v("1-2-3","4.2.2-3","洞身段钻孔物探综合测井测试成果表"),v("1-2-4","4.2.2-5","洞身段钻孔物探综合测井测试成果表（一）"),v("1-2-5","4.2.2-5","洞身段钻孔物探综合测井测试成果表（二）"),v("1-2-6","4.2.2-6","洞身段钻孔物探综合测井测试成果表")]),K("1-3","岩土参数建议",[v("1-3-1","1.3","隧道设计参数建议值一览表")])]),K("2","隧道工程地质评价",[K("2-1","隧道洞身工程地质评价",[v("2-1-1","—","围岩岩体完整程度定性划分表"),v("2-1-2","5.2.2-2","岩体完整度综合确定表"),v("2-1-3","5.2.3-3","隧道各级围岩分布情况表")]),K("2-2","竖井工程地质评价",[v("2-2-1","—","竖井工程地质评价")])]),K("3","隧道水文地质评价",[K("3-1","大气降水渗入法",[v("3-1-1","3.1-1","白云山隧道大气降雨入渗系数法计算成果")]),K("3-2","地下径流模数法",[v("3-2-1","3.2-1","地下径流模数法涌水量计算表")]),K("3-3","涌水量取值建议",[v("3-3-1","3.3-1","白云山隧道单洞涌水量分段预测表")])]),K("4","工程地质条件评价",[K("4-1","突水突泥预测",[v("4-1-1","—","白云山隧道突水突泥段落预测表")])])],we={left:{name:"左线隧道",chainage:{start:"ZK81+693",end:"ZK88+135",length:6442},entrance:{lon:107.333492,lat:29.298659,elevation:592.132},exit:{lon:107.398801,lat:29.28922,elevation:620.175},axisDirection:{min:75,max:105},segments:[{from:"ZK81+693",to:"ZK85+000",slope:.01453,gradePointElevation:640.585},{from:"ZK85+000",to:"ZK88+135",slope:-.0065}]},right:{name:"右线隧道",chainage:{start:"K81+705",end:"K88+109",length:6404},entrance:{lon:107.333701,lat:29.298371,elevation:592.597},exit:{lon:107.398503,lat:29.28857,elevation:620.55},axisDirection:{min:79,max:105},segments:[{from:"K81+705",to:"K85+000",slope:.014584,gradePointElevation:640.83},{from:"K85+000",to:"K88+109",slope:-.0065}]}},ve={left:{entrance:{x:-4115.94873046875,y:-1712.8272094726562,z:940.5238647460938},exit:{x:2654.744140625,y:-1712.8272094726562,z:940.5238647460938}},right:{entrance:{x:-4115.94873046875,y:-1741.1968383789062,z:940.5238647460938},exit:{x:2654.744140625,y:-1741.1968383789062,z:940.5238647460938}}},Y={lon:107.333492,lat:29.298659,height:620.55},Jt="基于WebGL的地下工程三维基础信息系统";function Me(e,t){const a=e==="left"?"◀":"▶",n=document.createElement("button");n.type="button",n.className=`sidebar-expand-tab sidebar-expand-tab--${e}`,n.setAttribute("aria-label",`展开${t}`),n.innerHTML=`<span class="sidebar-expand-tab__label">${t}</span>`;const l=document.createElement("button");return l.type="button",l.className=`sidebar-edge-btn sidebar-edge-btn--${e}`,l.setAttribute("aria-label",`收起${t}`),l.textContent=a,{expandTab:n,collapseBtn:l}}function es(){const e=document.createElement("div");e.id="app",e.className="app-shell",e.innerHTML=`
    ...
    <header class="app-header">
      ...
      <div class="app-header__title-wrap">
        <div class="app-header__title-frame">
          <h1 class="app-header__title">${Jt}</h1>
        </div>
      </div>
    </header>
  ...
  `,document.body.prepend(e);const t=e.querySelector(".app-sidebar--left"),s=e.querySelector(".app-sidebar--right"),a=t.querySelector(".sidebar-slide--left"),n=s.querySelector(".sidebar-slide--right"),l=Me("left","勘察数据"),i=Me("right","数据表格");a.innerHTML=`
  ...
  `;const o=document.createElement("div");o.id="chartPanelRoot",o.className="chart-panel-root",n.appendChild(i.collapseBtn),n.appendChild(o),a.appendChild(l.collapseBtn),t.appendChild(l.expandTab),s.appendChild(i.expandTab);function r(d,h){d.classList.toggle("is-collapsed",h),d.dataset.collapsed=h?"true":"false"}function c(d){return d.classList.contains("is-collapsed")}return l.collapseBtn.addEventListener("click",()=>{r(t,!0)}),l.expandTab.addEventListener("click",()=>{r(t,!1)}),i.collapseBtn.addEventListener("click",()=>{r(s,!0)}),i.expandTab.addEventListener("click",()=>{r(s,!1)}),{layerTreeRoot:e.querySelector("#layerTreeRoot"),chartPanelRoot:o,bottomToolbarRoot:e.querySelector("#bottomToolbarRoot"),cesiumContainer:e.querySelector("#cesiumContainer"),showLeftSidebar(){r(t,!1)},hideLeftSidebar(){r(t,!0)},showRightSidebar(){r(s,!1)},hideRightSidebar(){r(s,!0)},collapseSidebars(){r(t,!0),r(s,!0)},isRightSidebarCollapsed(){return c(s)},toggleLeftSidebar(){r(t,!c(t))},toggleRightSidebar(){r(s,!c(s))}}}function ts(e){var t;return!((t=e.children)!=null&&t.length)}function ss(e,t){const s=e.tableNo?`${e.tableNo} ${e.label}`:e.label;return`
  ...
  `}function as(e,t){const s=e.children.map(a=>vt(a,t+1)).join("");return`
...
<body>
...
</html>`,n=new Blob(["\uFEFF",a],{type:"application/vnd.ms-excel;charset=utf-8"}),l=URL.createObjectURL(n),i=document.createElement("a");i.href=l,i.download=s,i.click(),URL.revokeObjectURL(l)}function rs(e){return`<td>${e===""||e==null?"":e}</td>`}function cs(e){return`
    <colgroup>
  ...
  `}function us(e){return`<thead><tr>${e.map(s=>`<th>${s.label.replace(/\n/g,"<br />")}</th>`).join("")}</tr></thead>`}function ds(e,t){const s=t.slice(1).map(n=>n.key);let a="";for(const n of e){const l=n.rows.length;n.rows.forEach((i,o)=>{a+="<tr>",o===0&&(a+=`<td class="survey-table__sample" rowspan="${l}">${n.holeId}</td>`);for(const r of s)a+=rs(i[r]);a+="</tr>"})}return a}function hs(e){const t=e.headers,s=t.length;return`
  ...
  `}function Se(e){return e==null?{text:"",colspan:1,rowspan:1,className:""}:typeof e=="string"||typeof e=="number"?{text:String(e),colspan:1,rowspan:1,className:""}:{text:e.t??e.text??"",colspan:e.cs??e.colspan??1,rowspan:e.rs??e.rowspan??1,className:e.className??""}}function _t(e,t){const s=Se(t),a=[];s.colspan>1&&a.push(`colspan="${s.colspan}"`),s.rowspan>1&&a.push(`rowspan="${s.rowspan}"`),s.className&&a.push(`class="${s.className}"`);const n=a.length?` ${a.join(" ")}`:"";return`<${e}${n}>${s.text}</${e}>`}function ps(e){return e.map(t=>`<tr>${t.map(s=>_t("th",s)).join("")}</tr>`).join("")}function ms(e){return e.map(t=>`<tr>${t.map(s=>_t("td",s)).join("")}</tr>`).join("")}function gs(e,t){const s=e.reduce((n,l)=>Math.max(n,l.reduce((i,o)=>i+Se(o).colspan,0)),0),a=t.reduce((n,l)=>Math.max(n,l.reduce((i,o)=>i+Se(o).colspan,0)),0);return Math.max(s,a,1)}function fs(e){const t=gs(e.headerRows,e.rows);return`
    <div class="survey-table-wrap">
  ...
  `}const ys=10,bs=["density","ucsNatural","ucsSaturated","softening","tensile","shearPhi","shearC","elasticModulus","poisson"];function E(e){return`<td>${e===""||e==null?"":e}</td>`}function vs(){return`
    <colgroup>
      <col class="survey-table__col survey-table__col--sample" />
      ${bs.map(()=>'<col class="survey-table__col survey-table__col--num" />').join("")}
    </colgroup>
  `}function Cs(){return`
    <thead>
      <tr>
  ...
  `}function _s(e){let t="";for(const s of e){const a=s.rows.length,n=s.shearRowspan??0;s.rows.forEach((l,i)=>{t+="<tr>",i===0&&(t+=`<td class="survey-table__sample" rowspan="${a}">${s.sampleId}</td>`),t+=E(l.density),t+=E(l.ucsNatural),t+=E(l.ucsSaturated),t+=E(l.softening),t+=E(l.tensile),n>1?i===0&&(t+=`<td rowspan="${n}">${l.shearPhi??""}</td>`,t+=`<td rowspan="${n}">${l.shearC??""}</td>`):(t+=E(l.shearPhi),t+=E(l.shearC)),t+=E(l.elasticModulus),t+=E(l.poisson),t+="</tr>"})}return t}function Ss(e){return e.map(t=>`
        <tr class="survey-table__stat">
          <td class="survey-table__stat-label">${t.label}</td>
          ${t.values.map(s=>E(s)).join("")}
        </tr>
      `).join("")}function ks(e){return`
    <div class="survey-table-wrap">
      <table class="survey-table survey-table--extended">
        ...
        <tfoot>
          ...
          <tr class="survey-table__remark">
            <td class="survey-table__stat-label">备注</td>
            <td colspan="${ys-1}">${e.remark||""}</td>
          </tr>
        </tfoot>
      </table>
    </div>
  `}const Ts=7;function ws(){return`
    <colgroup>
      <col class="survey-table__col survey-table__col--sample" />
  ...
  `}function Z(e){return`<td>${e===""||e==null?"":e}</td>`}function Ns(e){let t="";for(const s of e){const a=s.rows.length,n=s.triaxialRowspan??0;s.rows.forEach((l,i)=>{t+="<tr>",i===0&&(t+=`<td class="survey-table__sample" rowspan="${a}">${s.sampleId}</td>`),t+=Z(l.density),t+=Z(l.ucsNatural),t+=Z(l.ucsSaturated),t+=Z(l.softening),n>1?i===0&&(t+=`<td rowspan="${n}">${l.c??"-"}</td>`,t+=`<td rowspan="${n}">${l.phi??"-"}</td>`):(t+=Z(l.c),t+=Z(l.phi)),t+="</tr>"})}return t}function Ps(e){return e.map(t=>`
        <tr class="survey-table__stat">
          <td class="survey-table__stat-label">${t.label}</td>
          ${t.values.map(s=>Z(s)).join("")}
        </tr>
      `).join("")}function Es(e){return`
    <div class="survey-table-wrap">
      <table class="survey-table">
        ...
        <tfoot>
          ...
          <tr class="survey-table__remark">
            <td class="survey-table__stat-label">备注</td>
            <td colspan="${Ts-1}">${e.remark||""}</td>
          </tr>
        </tfoot>
      </table>
    </div>
  `}function xs(e){return e.schema==="rockProperties"?ks(e):e.schema==="boreholeLog"?hs(e):e.schema==="matrixTable"?fs(e):Es(e)}function Ms(e){return`
  ...
  `}function Nt(e,t,s){return s[t]<=0?"":`<td class="drill-info-table__code-cell" rowspan="${s[t]}">${R(e.stratumCode)}</td>`}function Pt(e){const t=Ke(e);return`
    <table class="drill-info-table drill-info-table--basic">
      <tbody>
        <tr>
          <th scope="row">孔号</th>
          <td colspan="2">${R(e.id)}</td>
        </tr>
        <tr>
          <th scope="row">里程桩号</th>
          <td colspan="2">${R(e.mileageStake||"/")}</td>
        </tr>
        <tr>
          <th scope="row">孔口高程</th>
          <td colspan="2">${w(e.elevation)} m</td>
        </tr>
        <tr>
          <th scope="row">钻孔深度</th>
          <td colspan="2">${w(e.depth)} m</td>
        </tr>
        <tr>
  ...
  `}function Fs(e){const t=Tt(e),s=t.length,a=wt(t);return`
    <div class="drill-info-lithology-wrap">
      <table class="drill-info-table drill-info-table--lithology">
        ...
        <tbody>
          ${t.map((n,l)=>`
                <tr style="height: ${Bs(n)}px">
                  ${Kt(e,s,l)}
                  <td>${n.sequence}</td>
                  ${Nt(n,l,a)}
                  <td>${R(n.lithology)}</td>
                  <td>${St(n.from,n.to)}</td>
                  <td>${w(n.thickness)}</td>
                </tr>
              `).join("")}
        </tbody>
  ...
  `}function qs(e){const t=Tt(e),s=t.length,a=wt(t);return`
        ...
        <tbody>
          ${t.map((n,l)=>`
                <tr>
                  ...
                  <td>${w(n.thickness)}</td>
                  <td>${R(n.lithology)}</td>
                  <td class="drill-info-table__desc-cell">${R(n.description||"/")}</td>
                </tr>
              `).join("")}
        </tbody>
      </table>
  ...
  `}function Et(e){return`
    <div class="drill-info-water-legend">
      ...
      <span>稳定水位：${w(Ke(e))} m</span>
    </div>
  `}function Vs(e){const t=document.createElement("table");return t.innerHTML=`
    <thead>
      <tr>
        <th>层序</th>
        <th>地层代号</th>
    ...
    <tbody>
      ${e.layers.map((s,a)=>{const n=kt(s,a),l=s.stratumCode??"";return`
            <tr>
              <td>${n.sequence}</td>
              <td>${R(l)}</td>
              <td>${Ds(s.from,s.to)}</td>
              <td>${w(n.thickness)}</td>
              <td>${R(s.lithology)}</td>
              <td style="text-align:left;white-space:normal;">${R(s.description??"")}</td>
            </tr>
          `}).join("")}
    </tbody>
  `,t}function xt(e){var s;if(!((s=e==null?void 0:e.layers)!=null&&s.length))return;const t=Vs(e);Ct(t,`${e.id}_钻孔柱状图`)}function Hs(){const e=document.createElement("div");e.className="drill-full-log-modal",e.hidden=!0,e.innerHTML=`
  ...
  `,document.body.appendChild(e);const t=e.querySelector("#drillFullLogTitle"),s=e.querySelector("#drillFullLogBody");let a=null;function n(){e.hidden=!0,a=null}function l(i){i&&(a=i,t.textContent=`完整柱状图 — ${i.id}`,s.innerHTML=`
    ...
    `,e.hidden=!1)}return e.addEventListener("click",i=>{var r;const o=(r=i.target.closest("[data-action]"))==null?void 0:r.dataset.action;if(o){if(o==="close"){n();return}a&&o==="export-xls"&&xt(a)}}),{show:l,hide:n}}function zs(e){return`
  ...
  `}function js(e,{onClose:t}={}){const s=Hs();e.innerHTML=`
  ...
  `;const a=e.querySelector("#drillInfoBody"),n=e.querySelector("#drillInfoClose");let l=null;n.addEventListener("click",()=>{t==null||t()}),a.addEventListener("click",o=>{var c;const r=(c=o.target.closest("[data-action]"))==null?void 0:c.dataset.action;if(!(!r||!l)){if(r==="full-log"){s.show(l);return}r==="export"&&xt(l)}});function i(o){const r=Is(o);if(l=r,!r){a.innerHTML=`
        <div class="survey-table-empty">
          <p class="survey-table-empty__title">暂无钻孔数据</p>
          <p class="survey-table-empty__hint">该钻孔信息待接入</p>
        </div>
      `;return}a.innerHTML=zs(r)}return{showDrill:i}}function Us(e){return`
  ...
  `}function Xs(e){const t=document.createElement("div");t.className="right-panel__table",e.appendChild(t);const s=document.createElement("div");s.className="right-panel__function",s.hidden=!0,e.appendChild(s);const a=document.createElement("div");a.className="right-panel__drill-info",a.hidden=!0,e.appendChild(a);const n=Rs(t);let l="table",i=null,o=null;const r=new Map,c=js(a,{onClose(){p(o)}});function d(g,C,S){const m=document.createElement("div");m.className="function-panel",m.dataset.id=g,m.hidden=!0,m.innerHTML=Us(C);const _=m.querySelector(".function-panel__body"),T=S(_);s.appendChild(m),r.set(g,{wrapper:m,api:T})}function h(){t.hidden=!0,s.hidden=!0,a.hidden=!0}function p(g){l="table",i=null,h(),t.hidden=!1,r.forEach(({wrapper:C,api:S})=>{var m;C.hidden=!0,(m=S.deactivate)==null||m.call(S)}),g&&(o=g,n.showTable(g))}function u(g){l="drillInfo",i=null,h(),a.hidden=!1,r.forEach(({wrapper:C,api:S})=>{var m;C.hidden=!0,(m=S.deactivate)==null||m.call(S)}),c.showDrill(g)}function f(g){r.has(g)&&(l="function",i=g,h(),s.hidden=!1,r.forEach(({wrapper:C,api:S},m)=>{var T,I;const _=m===g;C.hidden=!_,_?(T=S.activate)==null||T.call(S):(I=S.deactivate)==null||I.call(S)}))}function b(){p(o)}return{showTable:p,showDrillInfo:u,showFunction:f,deactivateFunctions:b,registerFunctionPanel:d,getMode:()=>l,getActiveFunctionId:()=>i}}const Ws=[{id:"measure",label:"数据测量"},{id:"home",label:"首页"},{id:"model",label:"模型调节"},{id:"roam",label:"摄像机漫游"}];function Qs(e,{onSelect:t,defaultId:s="home"}={}){const a=document.createElement("nav");a.className="bottom-toolbar",a.setAttribute("aria-label","功能导航"),a.innerHTML=Ws.map(i=>`
    <button
      type="button"
      ...
      aria-pressed="false"
    >${i.label}</button>
  `).join(""),e.appendChild(a);let n=s;function l(i){n=i,a.querySelectorAll(".bottom-toolbar__btn").forEach(o=>{const r=o.dataset.id===i;o.classList.toggle("bottom-toolbar__btn--active",r),o.setAttribute("aria-pressed",r?"true":"false")})}return a.addEventListener("click",i=>{const o=i.target.closest(".bottom-toolbar__btn");!o||o.dataset.id===n||(l(o.dataset.id),t==null||t(o.dataset.id))}),l(s),{setActive:l,getActive:()=>n}}function Gs(e){const t=Cesium.Cartographic.fromCartesian(e);return{lon:Cesium.Math.toDegrees(t.longitude),lat:Cesium.Math.toDegrees(t.latitude),height:t.height}}function ke(e,t){const s=Cesium.Cartesian3.subtract(t,e.camera.positionWC,new Cesium.Cartesian3);return Cesium.Cartesian3.dot(s,e.camera.directionWC)>0}function pe(e,t,s=null){const a=Cesium.Cartographic.fromCartesian(e);return{cartesian:Cesium.Cartesian3.clone(e),cartographic:a,lonLatHeight:Gs(e),source:t,picked:s}}function Mt(e,t){const s=e.scene,a=s.pickPosition(t);if(Cesium.defined(a)&&ke(e,a))return pe(a,"depth");const n=s.pick(t);if(Cesium.defined(n)){const i=s.pickPosition(t);if(Cesium.defined(i)&&ke(e,i))return pe(i,"depth",n)}const l=e.camera.getPickRay(t);if(l){const i=s.globe.pick(l,s);if(Cesium.defined(i))return pe(i,"globe",n??null)}return null}function Js(e,t){const s=e.scene,a=s.pickPosition(t);if(Cesium.defined(a)&&ke(e,a))return a;const n=e.camera.getPickRay(t);if(n){const l=s.globe.pick(n,s);if(Cesium.defined(l))return l}return null}function ea({lon:e,lat:t,height:s},a=6){return{lon:e.toFixed(a),lat:t.toFixed(a),height:s.toFixed(2)}}const $={point:Cesium.Color.CYAN,line:Cesium.Color.YELLOW,polygon:Cesium.Color.fromCssColorString("#00d4ff").withAlpha(.35),outline:Cesium.Color.fromCssColorString("#00d4ff")},ta=$.line.withAlpha(.7),sa=$.polygon.withAlpha(.25),aa=$.outline.withAlpha(.7);function ut(e){let t=0;for(let s=1;s<e.length;s+=1){const a=new Cesium.EllipsoidGeodesic(e[s-1],e[s]);t+=a.surfaceDistance}return t}function na(e){if(e.length<3)return 0;const s=Cesium.EllipsoidTangentPlane.fromPoints(e).projectPointsOntoPlane(e);return Cesium.PolygonPipeline.computeArea2D(s)}function la(e){const t=new Cesium.ScreenSpaceEventHandler(e.scene.canvas),s=e.cesiumWidget.screenSpaceEventHandler,a=e.entities,n=[];let l=!1,i=null,o=[],r=[],c=null,d=null,h=null,p=null,u=0,f=null;const b=new Cesium.Cartesian2,g=[new Cesium.Cartesian3,new Cesium.Cartesian3],C=[],S=250;function m(y){return n.push(y),y}function _(y){return r.push(y),m(y)}function T(y){a.remove(y);const k=n.indexOf(y);k>=0&&n.splice(k,1)}function I(){h=null,d=null,c&&(a.remove(c),c=null),u&&(cancelAnimationFrame(u),u=0)}function oe(){return i==="distance"||i==="height"?"line":i==="area"?o.length>=3?"polygon":"line":null}function re(){return!h||o.length===0?[]:(i==="height"&&o.length>=2?(Cesium.Cartesian3.clone(o[0],g[0]),Cesium.Cartesian3.clone(o[1],g[1])):(Cesium.Cartesian3.clone(o[o.length-1],g[0]),Cesium.Cartesian3.clone(h,g[1])),g)}function ce(){if(!h||o.length<3)return new Cesium.PolygonHierarchy([]);C.length=0;for(let y=0;y<o.length;y+=1)C.push(o[y]);return C.push(h),new Cesium.PolygonHierarchy(C)}function Ft(){const y=oe();y&&(c&&d!==y&&(a.remove(c),c=null,d=null),!c&&(d=y,y==="line"?c=a.add({polyline:{positions:new Cesium.CallbackProperty(()=>re(),!1),width:2,material:ta}}):c=a.add({polygon:{hierarchy:new Cesium.CallbackProperty(()=>ce(),!1),material:sa,outline:!0,outlineColor:aa}})))}function qt(){if(u=0,!l||!i||o.length===0)return;const y=Js(e,b);y&&(h||(h=new Cesium.Cartesian3),Cesium.Cartesian3.clone(y,h),Ft())}function Vt(){o=[],r.forEach(y=>T(y)),r=[],I()}function V(){Vt(),i=null}function ue(){r=[],o=[],I(),i=null}function Ht(y,k){return _(a.add({position:y,point:{pixelSize:10,color:$.point,outlineColor:Cesium.Color.WHITE,outlineWidth:2,disableDepthTestDistance:Number.POSITIVE_INFINITY},label:void 0}))}function zt(y,k){return _(a.add({polyline:{positions:[y,k],width:3,material:$.line,clampToGround:!0}}))}function de(y,k){o.push(y),Ht(y),o.length>=2&&zt(o[o.length-2],y)}function jt(){if(o.length<2)return;const y=o.map(P=>Cesium.Cartographic.fromCartesian(P)),k=ut(y);f==null||f({type:"distance",value:k,unit:"m"}),ue()}function Ut(){if(o.length<3)return;const y=na(o);r.filter(k=>k.polyline).forEach(k=>{T(k);const P=r.indexOf(k);P>=0&&r.splice(P,1)}),m(a.add({polygon:{hierarchy:new Cesium.PolygonHierarchy(o),material:$.polygon,outline:!0,outlineColor:$.outline,outlineWidth:2}})),f==null||f({type:"area",value:y,unit:"m²"}),ue()}function Ee(){if(o.length<2)return;const y=Cesium.Cartographic.fromCartesian(o[0]),k=Cesium.Cartographic.fromCartesian(o[1]),P=k.height-y.height,he=ut([y,k]),A=r.filter(Qt=>Qt.point),xe={font:"13px sans-serif",fillColor:Cesium.Color.WHITE,outlineColor:Cesium.Color.BLACK,outlineWidth:2,style:Cesium.LabelStyle.FILL_AND_OUTLINE,verticalOrigin:Cesium.VerticalOrigin.BOTTOM,pixelOffset:new Cesium.Cartesian2(0,-14),disableDepthTestDistance:Number.POSITIVE_INFINITY};A[0]&&(A[0].label={...xe,text:"起点"}),A[1]&&(A[1].label={...xe,text:"终点"}),f==null||f({type:"height",heightDiff:P,horizontal:he,unit:"m"}),ue()}function Xt(){i==="distance"?jt():i==="area"?Ut():i==="height"&&Ee()}function Wt(y){if(!l||!i)return;const k=Mt(e,y.position);if(k){if(i==="height"){o.length===0?de(k.cartesian):o.length===1&&(de(k.cartesian),Ee());return}de(k.cartesian),i==="area"&&o.length===3&&(a.remove(c),c=null,d=null)}}return t.setInputAction(y=>{window.clearTimeout(p),p=window.setTimeout(()=>{p=null,Wt(y)},S)},Cesium.ScreenSpaceEventType.LEFT_CLICK),t.setInputAction(y=>{!l||!i||o.length===0||(b.x=y.endPosition.x,b.y=y.endPosition.y,u||(u=requestAnimationFrame(qt)))},Cesium.ScreenSpaceEventType.MOUSE_MOVE),t.setInputAction(()=>{window.clearTimeout(p),p=null,!(!l||!i||i==="height")&&Xt()},Cesium.ScreenSpaceEventType.LEFT_DOUBLE_CLICK),{setResultCallback(y){f=y},activate(){l=!0,s.removeInputAction(Cesium.ScreenSpaceEventType.LEFT_DOUBLE_CLICK)},deactivate(){l=!1,window.clearTimeout(p),p=null,u&&(cancelAnimationFrame(u),u=0),V(),s.setInputAction(y=>{const k=e.camera.pickEllipsoid(y.position,e.scene.globe.ellipsoid);if(!k)return;const P=Cesium.Cartographic.fromCartesian(k),he=e.scene.globe.getHeight(P)??0,A=e.camera.positionCartographic.height;e.camera.flyTo({destination:Cesium.Cartesian3.fromRadians(P.longitude,P.latitude,he+A*.5),duration:1})},Cesium.ScreenSpaceEventType.LEFT_DOUBLE_CLICK)},startDistance(){V(),i="distance"},startArea(){V(),i="area"},startHeight(){V(),i="height"},clearAll(){V(),n.forEach(y=>a.remove(y)),n.length=0},destroy(){t.destroy()}}}function ia(e){return e.type==="distance"?`距离：${e.value.toFixed(2)} ${e.unit}`:e.type==="area"?`面积：${e.value.toFixed(2)} ${e.unit}`:e.type==="height"?`高差：${e.heightDiff.toFixed(2)} m，水平距离：${e.horizontal.toFixed(2)} m`:""}function oa(e,t){e.innerHTML=`
  ...
  `;const s=e.querySelector("#measureResults"),a=la(t);return a.setResultCallback(n=>{const l=document.createElement("li");l.className="function-panel__result-item",l.textContent=ia(n),s.prepend(l)}),e.addEventListener("click",n=>{const l=n.target.closest("[data-mode]");if(!l)return;const i=l.dataset.mode;i==="distance"?a.startDistance():i==="area"?a.startArea():i==="height"?a.startHeight():i==="clear"&&(a.clearAll(),s.innerHTML="")}),{activate(){a.activate()},deactivate(){a.deactivate()}}}const ra=new Set(["w","a","s","d","q","e"]),ca=new Set(["arrowup","arrowdown","arrowleft","arrowright"]),D=30,Q=.004;function ua(e){let t=!1;const s=new Set;let a=null;function n(c){if(!t)return;const d=c.key.toLowerCase();(ra.has(d)||ca.has(d))&&(s.add(d),c.preventDefault())}function l(c){const d=c.key.toLowerCase();s.delete(d)}function i(){if(!t||s.size===0)return;const c=e.camera,d=1/60;s.has("w")&&c.moveForward(D*d),s.has("s")&&c.moveBackward(D*d),s.has("a")&&c.moveLeft(D*d),s.has("d")&&c.moveRight(D*d),s.has("q")&&c.moveDown(D*d),s.has("e")&&c.moveUp(D*d),s.has("arrowleft")&&c.lookLeft(Q),s.has("arrowright")&&c.lookRight(Q),s.has("arrowup")&&c.lookUp(Q),s.has("arrowdown")&&c.lookDown(Q)}function o(){t||(t=!0,document.addEventListener("keydown",n),document.addEventListener("keyup",l),a=e.clock.onTick.addEventListener(i))}function r(){t&&(t=!1,s.clear(),document.removeEventListener("keydown",n),document.removeEventListener("keyup",l),a&&(e.clock.onTick.removeEventListener(i),a=null))}return{activate:o,deactivate:r}}function da(e,t){e.innerHTML=`
    <div class="function-panel__section">
  ...
  `;const s=ua(t);return{activate(){s.activate()},deactivate(){s.deactivate()}}}const H=`
...
`,ha=[{id:"imagery",label:"地形影像图"},{id:"tunnel",label:"隧道模型"},{id:"drill",label:"钻孔模型"}];function pa(e){const t=e.locate?`
      <button
        type="button"
  ...
  `;const a=e.querySelectorAll("[data-layer]"),n=e.querySelector("[data-drill-locates]"),l=e.querySelector('[data-layer="drill"]');function i(){const r=t.isDrillLayerVisible();n.hidden=!r}function o(){a.forEach(r=>{const c=r.dataset.layer;c==="imagery"?r.checked=t.isImageryVisible():c==="tunnel"?r.checked=t.isTunnelVisible():c==="drill"&&(r.checked=t.isDrillLayerVisible())}),i()}return e.addEventListener("change",r=>{var p;const c=r.target.closest("[data-layer]");if(!c)return;const d=c.checked,h=c.dataset.layer;h==="imagery"?t.setImageryVisible(d):h==="tunnel"?t.setTunnelVisible(d):h==="drill"&&(t.setDrillLayerVisible(d),d||(p=s==null?void 0:s.current)==null||p.hideDrillPresentation(),i())}),e.addEventListener("click",r=>{var h,p;if(r.target.closest("[data-locate='initial']")){(h=s==null?void 0:s.current)==null||h.flyToInitial();return}const d=r.target.closest("[data-drill]");if(d){if(!l.checked)return;(p=s==null?void 0:s.current)==null||p.locateDrill(d.dataset.drill)}}),o(),{activate(){o()},deactivate(){}}}function B(e){return Number(e.toFixed(3))}function dt(e,t){const s=Cesium.Transforms.eastNorthUpToFixedFrame(e),a=Cesium.Matrix4.inverse(s,new Cesium.Matrix4),n=Cesium.Matrix4.multiplyByPoint(a,t,new Cesium.Cartesian3);return{x:n.x/1e3,y:n.y/1e3,z:n.z/1e3}}function F(e,t){const s=new Cesium.Cartesian3(t.x*1e3,t.y*1e3,t.z*1e3),a=Cesium.Transforms.eastNorthUpToFixedFrame(e);return Cesium.Matrix4.multiplyByPoint(a,s,new Cesium.Cartesian3)}function ga(e){const t=e.scene,s=t.canvas,a=new Cesium.Cartesian2(s.clientWidth/2,s.clientHeight/2);let n=t.pickPosition(a);if(!Cesium.defined(n)){const l=e.camera.getPickRay(a);n=t.globe.pick(l,t)}return Cesium.defined(n)||(n=Cesium.Cartesian3.add(e.camera.positionWC,Cesium.Cartesian3.multiplyByScalar(e.camera.directionWC,500,new Cesium.Cartesian3),new Cesium.Cartesian3)),n}function fa(e,t){const s=dt(t,e.camera.positionWC),a=dt(t,ga(e));return{position:s,target:a}}function ya(e){const{position:t,target:s}=e;return["INITIAL_CAMERA 预设（可复制到代码）:","const INITIAL_CAMERA = {",`  position: { x: ${B(t.x)}, y: ${B(t.y)}, z: ${B(t.z)} },`,`  target: { x: ${B(s.x)}, y: ${B(s.y)}, z: ${B(s.z)} },`,"};"].join(`
`)}function ba(e,t,s){const a=F(t,s.position),n=F(t,s.target),l=Cesium.Cartesian3.subtract(n,a,new Cesium.Cartesian3);Cesium.Cartesian3.normalize(l,l);const i=Cesium.Transforms.eastNorthUpToFixedFrame(a),o=Cesium.Matrix4.getColumn(i,2,new Cesium.Cartesian3);Cesium.Cartesian3.normalize(o,o),e.camera.setView({destination:a,orientation:{direction:l,up:o}})}function ht(e,t,s,{duration:a=1.5}={}){const n=F(t,s.position),l=F(t,s.target),i=Cesium.Cartesian3.subtract(l,n,new Cesium.Cartesian3);Cesium.Cartesian3.normalize(i,i);const o=Cesium.Transforms.eastNorthUpToFixedFrame(n),r=Cesium.Matrix4.getColumn(o,2,new Cesium.Cartesian3);return Cesium.Cartesian3.normalize(r,r),e.camera.flyTo({destination:n,orientation:{direction:i,up:r},duration:a})}const pt=Cesium.Color.fromCssColorString("#ffd700");function M(e){const t=document.getElementById(e);t&&t.remove()}function va(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Ca(e,t){const s=new Cesium.ScreenSpaceEventHandler(e.scene.canvas),a=e.entities;let n=0;const l=[];e.scene.canvas.addEventListener("contextmenu",d=>{d.preventDefault()});function i(d,h,p){M("locationMarkCoordsPopup");const u=document.createElement("div");u.id="locationMarkCoordsPopup",u.className="location-mark-coords-popup",u.innerHTML=`
      ...
      <dl class="location-mark-coords-popup__grid">
        <dt>经度</dt><dd>${h.lon}°</dd>
        <dt>纬度</dt><dd>${h.lat}°</dd>
        <dt>高程</dt><dd>${h.height} m</dd>
        <dt>X</dt><dd>${p.x.toFixed(2)}</dd>
        <dt>Y</dt><dd>${p.y.toFixed(2)}</dd>
        <dt>Z</dt><dd>${p.z.toFixed(2)}</dd>
      </dl>
    `,u.style.left=`${Math.min(d.x+12,window.innerWidth-280)}px`,u.style.top=`${Math.min(d.y+12,window.innerHeight-220)}px`,document.body.appendChild(u);const f=()=>{u.remove(),document.removeEventListener("click",b)},b=g=>{u.contains(g.target)||f()};u.querySelector(".location-mark-coords-popup__close").addEventListener("click",f),setTimeout(()=>document.addEventListener("click",b),0)}function o(d){M("locationMarkCoordsPopup"),M("locationMarkCameraPopup");const h=fa(e,t),p=ya(h);console.info(p);const u=document.createElement("div");u.id="locationMarkCameraPopup",u.className="location-mark-coords-popup location-mark-camera-popup",u.innerHTML=`
      <div class="location-mark-coords-popup__header">
        <span>相机坐标</span>
        <button type="button" class="location-mark-coords-popup__close" aria-label="关闭">×</button>
      </div>
      <pre class="location-mark-camera-popup__code">${va(p)}</pre>
      <div class="location-mark-camera-popup__actions">
        <button type="button" class="location-mark-camera-popup__copy">复制</button>
      </div>
    `,u.style.left=`${Math.min(d.x+12,window.innerWidth-360)}px`,u.style.top=`${Math.min(d.y+12,window.innerHeight-260)}px`,document.body.appendChild(u);const f=()=>{u.remove(),document.removeEventListener("click",b)},b=g=>{u.contains(g.target)||f()};u.querySelector(".location-mark-coords-popup__close").addEventListener("click",f),u.querySelector(".location-mark-camera-popup__copy").addEventListener("click",async()=>{const g=u.querySelector(".location-mark-camera-popup__copy");try{await navigator.clipboard.writeText(p),g.textContent="已复制",setTimeout(()=>{g.textContent="复制"},1500)}catch(C){console.error("复制失败:",C)}}),setTimeout(()=>document.addEventListener("click",b),0)}function r(d,h){M("locationMarkContextMenu"),M("locationMarkCoordsPopup"),M("locationMarkCameraPopup");const p=ea(h.lonLatHeight),u=h.cartesian,f=document.createElement("div");f.id="locationMarkContextMenu",f.className="location-mark-menu",f.innerHTML=`
      ...
      `:""}
    `,f.style.left=`${d.x}px`,f.style.top=`${d.y}px`,document.body.appendChild(f);const b=()=>{f.remove(),document.removeEventListener("click",g)},g=C=>{f.contains(C.target)||b()};setTimeout(()=>document.addEventListener("click",g),0),f.addEventListener("click",C=>{const S=C.target.closest("[data-action]");if(!S)return;const m=S.dataset.action;if(m==="coords")i(d,p,u);else if(m==="camera")o(d);else if(m==="mark"){n+=1;const _=`标记 ${n}`,T=a.add({position:u,point:{pixelSize:12,color:pt,outlineColor:Cesium.Color.WHITE,outlineWidth:2,disableDepthTestDistance:Number.POSITIVE_INFINITY},label:{text:_,font:"13px sans-serif",fillColor:pt,outlineColor:Cesium.Color.BLACK,outlineWidth:2,style:Cesium.LabelStyle.FILL_AND_OUTLINE,verticalOrigin:Cesium.VerticalOrigin.BOTTOM,pixelOffset:new Cesium.Cartesian2(0,-16),disableDepthTestDistance:Number.POSITIVE_INFINITY}});l.push({id:n,label:_,lon:p.lon,lat:p.lat,height:p.height,entity:T})}else m==="clear"&&c();b()})}function c(){l.forEach(d=>a.remove(d.entity)),l.length=0,n=0}return s.setInputAction(d=>{const h=Mt(e,d.position);h&&r(d.position,h)},Cesium.ScreenSpaceEventType.RIGHT_CLICK),{getMarks(){return[...l]},clearMarks:c,destroy(){M("locationMarkContextMenu"),M("locationMarkCoordsPopup"),M("locationMarkCameraPopup"),s.destroy()}}}function Rt(e,t,s,a){const n=Cesium.Cartesian3.subtract(t,e,new Cesium.Cartesian3),l=Cesium.Cartesian3.magnitude(n);Cesium.Cartesian3.normalize(n,n);const i=Cesium.Cartesian3.UNIT_Z;let o=Cesium.Cartesian3.cross(n,i,new Cesium.Cartesian3);Cesium.Cartesian3.magnitudeSquared(o)<1e-12?o=Cesium.Cartesian3.clone(Cesium.Cartesian3.UNIT_Y):Cesium.Cartesian3.normalize(o,o);const r=Cesium.Cartesian3.cross(o,n,new Cesium.Cartesian3);Cesium.Cartesian3.normalize(r,r);const c=Cesium.Cartesian3.subtract(a,s,new Cesium.Cartesian3),h=Cesium.Cartesian3.magnitude(c)/l,p=Cesium.Transforms.eastNorthUpToFixedFrame(s),u=Cesium.Matrix4.inverse(p,new Cesium.Matrix4),f=Cesium.Matrix4.multiplyByPointAsVector(u,c,new Cesium.Cartesian3);Cesium.Cartesian3.magnitudeSquared(f)<1e-12&&(f.x=0,f.y=1,f.z=0),Cesium.Cartesian3.normalize(f,f);const b=Cesium.Cartesian3.UNIT_Z;let g=Cesium.Cartesian3.cross(f,b,new Cesium.Cartesian3);Cesium.Cartesian3.magnitudeSquared(g)<1e-12?g=Cesium.Cartesian3.clone(Cesium.Cartesian3.UNIT_X):Cesium.Cartesian3.normalize(g,g);const C=Cesium.Cartesian3.cross(g,f,new Cesium.Cartesian3);Cesium.Cartesian3.normalize(C,C);const S=mt(n,o,r),m=Cesium.Matrix3.transpose(S,new Cesium.Matrix3),_=mt(f,g,C),T=Cesium.Matrix3.multiply(_,m,new Cesium.Matrix3),I=Cesium.Matrix4.fromTranslation(Cesium.Cartesian3.negate(e,new Cesium.Cartesian3),new Cesium.Matrix4),oe=Cesium.Matrix4.fromRotation(T,new Cesium.Matrix4),re=Cesium.Matrix4.multiplyByScale(oe,new Cesium.Cartesian3(h,h,h),new Cesium.Matrix4);let ce=Cesium.Matrix4.multiply(re,I,new Cesium.Matrix4);return Cesium.Matrix4.multiply(p,ce,new Cesium.Matrix4)}function mt(e,t,s){return Cesium.Matrix3.fromColumnMajorArray([e.x,e.y,e.z,t.x,t.y,t.z,s.x,s.y,s.z])}function x(e){return new Cesium.Cartesian3(e.x,e.y,e.z)}function G(e,t){return Cesium.Matrix4.multiplyByPoint(e,t,new Cesium.Cartesian3)}function _a(e,t){const s=ve.left,a=Cesium.Cartesian3.fromDegrees(Y.lon,Y.lat,Y.height),n=Cesium.Cartesian3.subtract(t,e,new Cesium.Cartesian3),l=Cesium.Cartesian3.add(a,n,new Cesium.Cartesian3);return Rt(x(s.entrance),x(s.exit),a,l)}function Sa(){return Cesium.Cartesian3.fromDegrees(Y.lon,Y.lat,Y.height)}async function ka(e){await e.readyPromise;const t=e.root;t!=null&&t.transform&&!Cesium.Matrix4.equalsEpsilon(t.transform,Cesium.Matrix4.IDENTITY,Cesium.Math.EPSILON10)&&(t.transform=Cesium.Matrix4.IDENTITY.clone())}function Ta(e,t,s,a){const n=ve.left,l=ve.right,i=[{modelEntrance:x(n.entrance),modelExit:x(n.exit)},{modelEntrance:x(n.exit),modelExit:x(n.entrance)}];let o=null,r=Number.POSITIVE_INFINITY,c=null;for(const d of i){const h=Rt(d.modelEntrance,d.modelExit,e,t),p={leftEntrance:Cesium.Cartesian3.distance(G(h,x(n.entrance)),e),leftExit:Cesium.Cartesian3.distance(G(h,x(n.exit)),t),rightEntrance:Cesium.Cartesian3.distance(G(h,x(l.entrance)),s),rightExit:Cesium.Cartesian3.distance(G(h,x(l.exit)),a)},u=p.rightEntrance+p.rightExit;u<r&&(r=u,o=h,c=p)}return{matrix:o,errors:c}}function wa(e,t=0){return Cesium.Cartesian3.fromDegrees(e.lon,e.lat,t)}function q(e){return wa(e,e.elevation)}function Ka(e,t){Object.entries(t).forEach(([,s])=>{const a=q(s.entrance),n=q(s.exit);e.entities.add({name:`${s.name}进口`,position:a,point:{pixelSize:12,color:Cesium.Color.LIME,outlineWidth:2,outlineColor:Cesium.Color.BLACK},label:{text:`${s.name}进口
...
H=${s.exit.elevation.toFixed(3)}m`,font:"14px sans-serif",fillColor:Cesium.Color.WHITE,outlineColor:Cesium.Color.BLACK,outlineWidth:2,style:Cesium.LabelStyle.FILL_AND_OUTLINE,verticalOrigin:Cesium.VerticalOrigin.BOTTOM,pixelOffset:new Cesium.Cartesian2(0,-14)}})})}const O={tx:0,ty:-529,tz:322,rx:0,ry:0,rz:9.4},Na={tx:10.27,ty:-528.74,tz:283.71,rx:0,ry:0,rz:9.4,scale:.992},z={tx:0,ty:0,tz:0,rx:0,ry:0,rz:0,scale:1};function Pa(e,t,s){const a=Cesium.Matrix3.fromRotationX(Cesium.Math.toRadians(e),new Cesium.Matrix3),n=Cesium.Matrix3.fromRotationY(Cesium.Math.toRadians(t),new Cesium.Matrix3),l=Cesium.Matrix3.fromRotationZ(Cesium.Math.toRadians(s),new Cesium.Matrix3);let i=Cesium.Matrix3.multiply(n,a,new Cesium.Matrix3);return i=Cesium.Matrix3.multiply(l,i,i),i}function Ea(e=z,t=!0){return t?{tx:O.tx+e.tx,ty:O.ty+e.ty,tz:O.tz+e.tz,rx:O.rx+e.rx,ry:O.ry+e.ry,rz:O.rz+e.rz,scale:e.scale??1}:{tx:e.tx,ty:e.ty,tz:e.tz,rx:e.rx,ry:e.ry,rz:e.rz,scale:e.scale??1}}function Lt(e,t){const s=Cesium.Transforms.eastNorthUpToFixedFrame(e),a=Cesium.Matrix4.inverse(s,new Cesium.Matrix4),n=Cesium.Matrix4.fromTranslation(new Cesium.Cartesian3(t.tx,t.ty,t.tz),new Cesium.Matrix4),l=Cesium.Matrix4.fromRotation(Pa(t.rx,t.ry,t.rz),new Cesium.Matrix4),i=Cesium.Matrix4.fromScale(new Cesium.Cartesian3(t.scale,t.scale,t.scale),new Cesium.Matrix4);let o=Cesium.Matrix4.multiply(n,l,new Cesium.Matrix4);return o=Cesium.Matrix4.multiply(o,i,o),Cesium.Matrix4.multiply(s,Cesium.Matrix4.multiply(o,a,new Cesium.Matrix4),new Cesium.Matrix4)}function xa(e,t){const s=Lt(e,Na);return Cesium.Matrix4.multiply(s,t,new Cesium.Matrix4)}function Ma(e,t,s=z,{applyRegistration:a=!0,initialPlacementMatrix:n=null}={}){const l=Ea(s,a),i=Lt(t,l);if(!a){const o=n??Cesium.Matrix4.IDENTITY;return Cesium.Matrix4.multiply(i,o,new Cesium.Matrix4)}return Cesium.Matrix4.multiply(i,e,new Cesium.Matrix4)}const It={position:{x:-.064,y:-.059,z:.028},target:{x:.02,y:-.03,z:-.04}},j=1;function Te(e,t){if(t>=1){e.scene.globe.translucency.enabled=!1,e.scene.globe.translucency.frontFaceAlpha=1;return}e.scene.globe.translucency.enabled=!0,e.scene.globe.translucency.frontFaceAlpha=t}function Ra(e){const t=e.imageryLayers;for(let a=0;a<t.length;a+=1)t.get(a).show=!1;const s=e.scene.globe;s.show=!1,s.translucency.enabled=!1,s.translucency.frontFaceAlpha=1}function La(e){const t=e.imageryLayers;for(let a=0;a<t.length;a+=1){const n=t.get(a);n.show=!0,n.alpha=1}const s=e.scene.globe;s.show=!0,Te(e,j)}function Ia(e,t=document.body){Te(e,j);const s=document.createElement("div");s.className="control-panel translucency-panel",s.innerHTML=`
    ...
    <div class="translucency-panel__control">
      <input
        ...
        value="${j}"
      />
      <span id="globeAlphaValue" class="translucency-panel__value">${j.toFixed(2)}</span>
    </div>
  `,t.appendChild(s);const a=s.querySelector("#globeAlphaSlider"),n=s.querySelector("#globeAlphaValue");function l(i){a.value=String(i),n.textContent=i.toFixed(2)}return a.addEventListener("input",()=>{const i=Number(a.value);Te(e,i),n.textContent=i.toFixed(2)}),{setAlpha:l}}const me={min:-1e3,max:1e3,step:1,decimals:1},ge={min:-90,max:90,step:.1,decimals:1},Za={min:.5,max:2,step:.001,decimals:3},gt=[{key:"tx",label:"东向 E (m)",group:"粗调平移",...me},{key:"ty",label:"北向 N (m)",group:"粗调平移",...me},{key:"tz",label:"天向 U (m)",group:"粗调平移",...me},{key:"rx",label:"绕 X 轴 (东) °",group:"粗调旋转",...ge},{key:"ry",label:"绕 Y 轴 (北) °",group:"粗调旋转",...ge},{key:"rz",label:"绕 Z 轴 (天) °",group:"粗调旋转",...ge},{key:"scale",label:"缩放倍率",group:"粗调缩放",...Za}];function Zt(e,t){return String(Number(e.toFixed(t)))}function $a(e,t){return`
    <div class="control-panel__row">
      ...
      <input
        ...
        max="${e.max}"
        step="${e.step}"
        value="${Zt(t,e.decimals)}"
        data-key="${e.key}"
      />
    </div>
  `}function Aa({tileset:e,baseMatrix:t,anchor:s,initialPlacementMatrix:a=null,applyRegistration:n=!0,container:l=document.body}){let i=[],o=n;const r={...z},c=document.createElement("div");c.className="control-panel tileset-panel";const d=["粗调平移","粗调旋转","粗调缩放"];c.innerHTML=`
    <div class="control-panel__title">模型粗调</div>
    ${d.map(u=>{const f=gt.filter(b=>b.group===u);return`
          <div class="control-panel__section">
            <div class="control-panel__section-title">${u}</div>
            ${f.map(b=>$a(b,r[b.key])).join("")}
          </div>
        `}).join("")}
    <button type="button" class="control-panel__reset">重置粗调</button>
  `,l.appendChild(c);function h(){if(i.length===0)return;const u=Ma(t,s,r,{applyRegistration:o,initialPlacementMatrix:a});for(const f of i)f.modelMatrix=u}function p(u,f){const b=gt.find(m=>m.key===u),g=Cesium.Math.clamp(f,b.min,b.max);r[u]=g;const C=c.querySelector(`input[type="range"][data-key="${u}"]`),S=c.querySelector(`input[type="number"][data-key="${u}"]`);C.value=String(g),S.value=Zt(g,b.decimals),h()}return c.querySelectorAll("input[type='range']").forEach(u=>{u.addEventListener("input",()=>{p(u.dataset.key,Number(u.value))})}),c.querySelectorAll("input[type='number']").forEach(u=>{u.addEventListener("change",()=>{p(u.dataset.key,Number(u.value))})}),c.querySelector(".control-panel__reset").addEventListener("click",()=>{Object.keys(z).forEach(u=>{p(u,z[u])})}),h(),{panel:c,getAdjust:()=>({...r}),setAdjust:u=>{Object.entries(u).forEach(([f,b])=>{f in r&&p(f,b)})},setTileset:u=>{i=u?[u]:[],h()},setTilesets:u=>{i=u??[],h()},setApplyRegistration:u=>{o=u,h()},getApplyRegistration:()=>o,reapplyMatrix:h}}const Da={width:5.6,height:3.2},ft={out2:{label:"钻孔1",camera:{position:{x:1.151,y:.184,z:.214},target:{x:1.158,y:.18,z:.212}},popupEnu:{x:1.409,y:.002,z:.128},popupSize:{width:140,height:80}},out3:{label:"钻孔2",camera:{position:{x:2.178,y:-.108,z:.479},target:{x:1.633,y:-.061,z:.117}},popupEnu:{x:1.726,y:-.052,z:.211},popupSize:{width:168,height:96}},out4:{label:"钻孔3",camera:{position:{x:3.535,y:-1.084,z:.376},target:{x:11.503,y:7.684,z:-.636}},popupEnu:{x:4.054,y:-.57,z:.265},popupSize:{width:224,height:128}}};function Ba(e,t){var s;return e.popupEnu?F(t,e.popupEnu):(s=e.camera)!=null&&s.target?F(t,e.camera.target):null}const Oa="out1",ne=["out1","out"],U=["out2","out3","out4"],$t={skipLevelOfDetail:!0,baseScreenSpaceError:1024,skipScreenSpaceErrorFactor:16,cullWithChildrenBounds:!0,dynamicScreenSpaceError:!0,dynamicScreenSpaceErrorDensity:.002,foveatedScreenSpaceError:!0,foveatedConeSize:.1},Ya={...$t,maximumScreenSpaceError:20},Fa={...$t,maximumScreenSpaceError:48};function qa(e){return ne.includes(e)?Ya:Fa}const At=[{label:"钻孔1",folder:"out2"},{label:"钻孔2",folder:"out3"},{label:"钻孔3",folder:"out4"}];async function Va(e,t){await t.readyPromise;const s=t.boundingSphere.radius;await e.flyTo(t,{duration:1.5,offset:new Cesium.HeadingPitchRange(0,Cesium.Math.toRadians(-35),Math.max(s*2.5,30))})}function Ha(e,t){if(!Cesium.defined(e))return null;let s=e.tileset;if(!s&&e.content&&(s=e.content.tileset),!s&&e.primitive instanceof Cesium.Cesium3DTileset&&(s=e.primitive),!s)return null;for(const a of U)if(t.get(a)===s)return a;return null}function za({viewer:e,tilesetByFolder:t,tilesetVisibility:s,anchor:a,popupManager:n,legendPanel:l,initialCamera:i}){let o="initial",r=null,c=null;function d(){r==null||r(o)}function h(){n==null||n.hide(),l==null||l.hide()}async function p(m){if(!(s!=null&&s.isDrillLayerVisible()))return!1;try{return await s.showDrillTileset(m),!0}catch(_){return console.error("显示钻孔模型失败:",_),!1}}async function u(m){const _=ft[m];if(_!=null&&_.camera){await ht(e,a,_.camera);return}const T=t.get(m);if(!T){console.warn(`未找到模型: ${m}`);return}await Va(e,T)}async function f(m){const _=ft[m];if(!_){n==null||n.hide();return}const T=Ba(_,a);await(n==null?void 0:n.show({worldPosition:T,title:_.label,size:_.popupSize}))}async function b({moveCamera:m=!0}={}){if(o="initial",h(),s!=null&&s.isDrillLayerVisible()&&await s.showDrillTilesets(),d(),!!m)try{await ht(e,a,i)}catch(_){console.error("回到初始视角失败:",_)}}async function g(m){if(m==="initial"){await b();return}if(h(),!!await p(m)){o=m,d();try{await u(m)}catch(T){console.error("飞行定位失败:",T)}}}async function C(m){if(!(!(s!=null&&s.isDrillLayerVisible())||(o!==m&&(n==null||n.hide()),!await p(m)))){o=m,l==null||l.show(),d(),c==null||c(m);try{await f(m)}catch(T){console.error("显示钻孔弹窗失败:",T)}}}function S(){const m=new Cesium.ScreenSpaceEventHandler(e.scene.canvas);return m.setInputAction(_=>{const T=Ha(e.scene.pick(_.position),t);T&&C(T)},Cesium.ScreenSpaceEventType.LEFT_CLICK),()=>m.destroy()}return{DRILL_HOLES:At,locateDrill:g,pickDrill:C,flyToInitial:b,hideLegend:()=>l==null?void 0:l.hide(),hideDrillPresentation:h,getActiveFolder:()=>o,setOnActiveChange:m=>{r=m},setOnDrillPick:m=>{c=m},bindSceneClick:S}}function ja({viewer:e,tilesetByFolder:t,tilesetVisibility:s,anchor:a,popupManager:n,legendPanel:l,initialCamera:i,container:o=document.body}){const r=za({viewer:e,tilesetByFolder:t,tilesetVisibility:s,anchor:a,popupManager:n,legendPanel:l,initialCamera:i}),c=document.createElement("div");c.className="control-panel drill-hole-panel",c.innerHTML=`
    ...
    <div class="control-panel__row drill-hole-panel__row">
      ...
      <select id="drillHoleSelect" class="drill-hole-panel__select">
        ...
        ${At.map(p=>`<option value="${p.folder}">${p.label}</option>`).join("")}
      </select>
    </div>
  `,o.appendChild(c);const d=c.querySelector("#drillHoleSelect");r.setOnActiveChange(p=>{d.value=p}),d.addEventListener("change",()=>{const p=d.value;if(p==="initial"){r.flyToInitial();return}r.locateDrill(p)});const h=r.bindSceneClick();return{panel:c,...r,flyTo:p=>r.locateDrill(p),destroy(){h()}}}const Ua=[{name:"红黏土",color:"#C05030"},{name:"灰岩",color:"#D9D9D9"},{name:"白云岩",color:"#CFE2F3"},{name:"溶洞",color:"#4A90E2"},{name:"煤",color:"#000000"},{name:"炭质页岩",color:"#6B6B6B"},{name:"页岩",color:"#808080"},{name:"砂质页岩",color:"#B7B29A"},{name:"角砾岩",color:"#C49A6C"},{name:"铝土岩",color:"#A74E1F"},{name:"采空区",color:"#C0C0C0"},{name:"红黏土(可塑)",color:"#D55E3A"},{name:"地下水位线",type:"line",lineStyle:"dashed",color:"#1E88E5"},{name:"岩界线",type:"line",lineStyle:"solid",color:"#000000"}],Xa="图 例(柱状图填充样式)";function Wa({name:e,color:t,type:s="fill",lineStyle:a="dashed",image:n}){return s==="line"?`
  ...
  `}function Qa(e=document.body){const t=document.createElement("div");return t.className="lithology-legend-panel",t.hidden=!0,t.innerHTML=`
    <div class="lithology-legend">
      <div class="lithology-legend__title">${Xa}</div>
      <ul class="lithology-legend__list">
        ${Ua.map(Wa).join("")}
      </ul>
    </div>
  `,e.appendChild(t),{panel:t,show(){t.hidden=!1},hide(){t.hidden=!0},isVisible:()=>!t.hidden}}const Ga="/suidao/img/popup_panel.png",fe=1120,ye=640,Ja=2,en=4;function tn(e){return new Promise((t,s)=>{const a=new Image;a.onload=()=>t(a),a.onerror=s,a.src=e})}function sn(e,t){const s=Cesium.Ellipsoid.WGS84.geodeticSurfaceNormal(e,new Cesium.Cartesian3);return Cesium.Cartesian3.add(e,Cesium.Cartesian3.multiplyByScalar(s,t,new Cesium.Cartesian3),new Cesium.Cartesian3)}function an(e,t,s){const a=Cesium.Cartesian3.subtract(e.camera.positionWC,t,new Cesium.Cartesian3);return Cesium.Cartesian3.magnitudeSquared(a)<1e-6?t:(Cesium.Cartesian3.normalize(a,a),Cesium.Cartesian3.add(t,Cesium.Cartesian3.multiplyByScalar(a,s,new Cesium.Cartesian3),new Cesium.Cartesian3))}function nn(e,t){let s=Cesium.Cartesian3.clone(t);return s=sn(s,Ja),s=an(e,s,en),s}async function ln(e){const t=await tn(Ga),s=document.createElement("canvas");s.width=fe,s.height=ye;const a=s.getContext("2d");return a.drawImage(t,0,0,fe,ye),a.font='600 72px "Segoe UI", "Microsoft YaHei", sans-serif',a.fillStyle="#67e8f9",a.textAlign="center",a.textBaseline="middle",a.shadowColor="rgba(34, 211, 238, 0.6)",a.shadowBlur=16,a.fillText(e,fe/2,ye*.42),s}function on(e){let t=null,s=0;function a(){s+=1,t&&(e.entities.remove(t),t=null)}async function n({worldPosition:l,title:i,size:o=Da}){const r=++s;t&&(e.entities.remove(t),t=null);const c=await ln(i);r===s&&(t=e.entities.add({position:nn(e,l),billboard:{image:c,sizeInMeters:!0,width:o.width,height:o.height,verticalOrigin:Cesium.VerticalOrigin.BOTTOM,horizontalOrigin:Cesium.HorizontalOrigin.CENTER,disableDepthTestDistance:Number.POSITIVE_INFINITY}}))}return{show:n,hide:a,getCurrent:()=>t}}function rn(e,t,{loadTileset:s,onGlobeAlphaChange:a}={}){let n=!0,l=!0,i=!0;function o(b){if(n=b,b){La(e),a==null||a(j);return}Ra(e),a==null||a(0)}function r(b){l=b;for(const g of ne){const C=t.get(g);C&&(C.show=b)}}function c(){for(const b of U){const g=t.get(b);g&&(g.show=!1)}}async function d(){for(const b of U){let g=t.get(b);!g&&s&&(g=await s(b)),g&&(await g.readyPromise,e.scene.primitives.contains(g)||e.scene.primitives.add(g),g.show=!0)}}async function h(){if(!i){c();return}await d()}async function p(b){U.includes(b)&&await h()}function u(){c()}function f(b){if(i=b,!b){c();return}h()}return{setImageryVisible:o,setTunnelVisible:r,setDrillLayerVisible:f,isImageryVisible:()=>n,isTunnelVisible:()=>l,isDrillLayerVisible:()=>i,hideDrillTilesets:u,showDrillTileset:p,showDrillTilesets:h}}window.CESIUM_BASE_URL="/suidao/cesium/";const{layerTreeRoot:cn,chartPanelRoot:un,bottomToolbarRoot:dn,cesiumContainer:hn,showRightSidebar:le,hideLeftSidebar:pn}=es(),ee={current:null},L=Xs(un),yt=ns(cn,Gt,{onSelect(e){L.getMode()==="table"&&(L.showTable(e),le())}});function Dt({resetScene:e=!1}={}){var s;e&&((s=ee.current)==null||s.flyToInitial({moveCamera:!1}));const t=yt.getNodeById(ct);yt.setActive(ct),L.showTable(t),le()}Dt();const X=document.createElement("div");X.className="dev-tools";X.hidden=!0;document.body.appendChild(X);Cesium.Ion.defaultAccessToken="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiJmNDUxZjAzYi1mZDIwLTQ3ZTQtYTNkYi05NzljZDVmM2Y0N2IiLCJpZCI6MzU5MTc2LCJpYXQiOjE3NjI4NDA2NDN9.NJ8S_lNZjtgvTdf7i2DyMIofYthpzdvb2OJaI1nfyS0";const mn="9e2778516442f77735a580e624742cb2";function Bt(e){return new Cesium.UrlTemplateImageryProvider({url:`https://t{s}.tianditu.gov.cn/DataServer?T=${e}_w&x={x}&y={y}&l={z}&tk=${mn}`,subdomains:["0","1","2","3","4","5","6","7"],maximumLevel:18})}const N=new Cesium.Viewer(hn,{terrain:Cesium.Terrain.fromWorldTerrain(),animation:!1,timeline:!1,baseLayerPicker:!1,geocoder:!0,homeButton:!0,sceneModePicker:!0,navigationHelpButton:!0,fullscreenButton:!0,selectionIndicator:!1,baseLayer:new Cesium.ImageryLayer(Bt("img"))});N.imageryLayers.addImageryProvider(Bt("cia"));N.scene.globe.depthTestAgainstTerrain=!1;N.scene.pickTranslucentDepth=!0;L.registerFunctionPanel("measure","数据测量",e=>oa(e,N));L.registerFunctionPanel("roam","摄像机漫游",e=>da(e,N));Qs(dn,{onSelect(e){if(e==="home"){Dt({resetScene:!0});return}L.showFunction(e),le()}});const ie=document.createElement("div");ie.className="control-panel-stack control-panel-stack--right";X.appendChild(ie);const gn=Ia(N,ie),fn=on(N),yn=Qa(document.getElementById("app")),W=Sa();Ca(N,W);ba(N,W,It);const te=we.left,se=we.right,Ot=q(te.entrance),Yt=q(te.exit),bn=q(se.entrance),vn=q(se.exit);Ka(N,we);const{matrix:Cn,errors:J}=Ta(Ot,Yt,bn,vn),_n=xa(W,_a(Ot,Yt));console.info("隧道配准误差（米）:",{左线进口:J.leftEntrance.toFixed(2),左线出口:J.leftExit.toFixed(2),右线进口:J.rightEntrance.toFixed(2),右线出口:J.rightExit.toFixed(2)});console.info("隧道设计路面高程（米）:",{左线进口:te.entrance.elevation,左线出口:te.exit.elevation,右线进口:se.entrance.elevation,右线出口:se.exit.elevation});const bt=[],ae=new Map,be=new Map,Sn=Aa({tileset:null,baseMatrix:Cn,anchor:W,initialPlacementMatrix:_n,applyRegistration:!1,container:X});function kn(e){return`/suidao/model/${e}/tileset.json`}async function Tn(e){try{const t=await fetch(e,{method:"HEAD"});return t.ok?(t.headers.get("content-type")||"").includes("json"):!1}catch{return!1}}async function Ne(e){const t=ae.get(e);if(t)return t;const s=be.get(e);if(s)return s;const a=(async()=>{const n=kn(e);if(!await Tn(n)){const i=`模型未找到: public/model/${e}/tileset.json`;if(ne.includes(e))throw new Error(i);return console.warn(i),null}const l=await Cesium.Cesium3DTileset.fromUrl(n,qa(e));return await ka(l),ae.set(e,l),bt.push(l),Sn.setTilesets(bt),l})();be.set(e,a);try{return await a}finally{be.delete(e)}}const Pe=rn(N,ae,{loadTileset:Ne,onGlobeAlphaChange:e=>gn.setAlpha(e)});L.registerFunctionPanel("model","模型调节",e=>ma(e,Pe,ee));const wn=Pe;function Kn(){const e=async()=>{await Promise.all(U.map(t=>Ne(t))),await Pe.showDrillTilesets()};typeof requestIdleCallback=="function"?requestIdleCallback(()=>{e()}):setTimeout(e,2e3)}Promise.all(ne.map(e=>Ne(e))).then(async e=>{if(!e[0])throw new Error(`主隧道模型未找到: public/model/${Oa}/tileset.json`);for(const s of e)s&&N.scene.primitives.add(s);Kn(),ee.current=ja({viewer:N,tilesetByFolder:ae,tilesetVisibility:wn,anchor:W,popupManager:fn,legendPanel:yn,initialCamera:It,container:ie}),ee.current.setOnDrillPick(s=>{pn(),L.showDrillInfo(s),le()})}).catch(e=>{console.error("加载隧道模型失败:",e)});
